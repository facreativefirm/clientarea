...
>(({ className, sideOffset = 4, ...props }, ref) => (
    <DropdownMenuPrimitive.Content
        ...
        className={cn(
            "z-50 min-w-[8rem] overflow-hidden rounded-2xl border bg-background p-1 text-popover-foreground shadow-xl glass animate-in data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
            className
        )}
        {...props}
    />
