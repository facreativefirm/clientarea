...
export default function AdminQuotePrintPage() {
        ...
        <>
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '10px' }}>
                    <div style={{ width: '40%' }}>
                        ...
                        <div style={{
                            ...
                            <span style={{ color: '#3b82f6' }}>{formatPrice(quote.totalAmount)}</span>
                        </div>
                    </div>
                </div>

                {/* Notes Only - Terms Removed */}
                {quote.notes && (
                    <div style={{
                        marginTop: '20px',
                        paddingTop: '10px',
                ...
                <div style={{
                    ...
                    <div>Thank you for considering our proposal.</div>
